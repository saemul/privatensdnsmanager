	...
	<div class="col-md-6 col-md-offset-3">
		<div class="panel panel-default">
			...
			<div class="panel-footer">
				<center><a id='confirmed' data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing" href="index.php?m=privatensdns&domainname={$domainname}&confirm" id="confirm_dns" class="btn btn-primary"> Konfirmasi</a></center>
			</div>
		</div>
	</div>
</div>
